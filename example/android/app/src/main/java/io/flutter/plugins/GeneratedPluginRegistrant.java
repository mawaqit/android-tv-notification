...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.notification_overlay.NotificationOverlayPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin notification_overlay, com.example.notification_overlay.NotificationOverlayPlugin", e);
    }
  }
}
